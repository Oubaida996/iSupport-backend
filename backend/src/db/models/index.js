...
db.users.belongsToMany(db.communities ,{through :db.users_communities  ,foreignKey: "user_id"} );
db.communities.belongsToMany(db.users ,{through :db.users_communities ,foreignKey: "community_id"} );
